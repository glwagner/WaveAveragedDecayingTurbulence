...
filename_medium_waves = "decaying_turbulence_256_surface_waves_xz.jld2"
filename_deep_waves   = "decaying_turbulence_256_very_deep_surface_waves_xz.jld2"
filename_strong_waves = "decaying_turbulence_256_strong_surface_waves_xz.jld2"

averages_filename_medium_waves = "decaying_turbulence_256_surface_waves_averages.jld2"
averages_filename_deep_waves   = "decaying_turbulence_256_very_deep_surface_waves_averages.jld2"
averages_filename_strong_waves = "decaying_turbulence_256_strong_surface_waves_averages.jld2"

ωmt = FieldTimeSeries(filename_medium_waves, "η")
ωdt = FieldTimeSeries(filename_deep_waves, "η")
ωst = FieldTimeSeries(filename_strong_waves, "η")

Umt = FieldTimeSeries(averages_filename_medium_waves, "u")
Udt = FieldTimeSeries(averages_filename_deep_waves, "u")
Ust = FieldTimeSeries(averages_filename_strong_waves, "u")

t = ωmt.times
Nt = length(t)

set_theme!(Theme(fontsize=48))
fig = Figure(resolution=(2700, 2000))
